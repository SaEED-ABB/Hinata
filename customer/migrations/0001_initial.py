    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(blank=True, choices=[('user', 'Normal User'), ('admin', 'Admin User')], default='user', max_length=200, null=True)),
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to=customer.models.User.generate_picture_path, validators=[store.helpers.validators.file_size])),
